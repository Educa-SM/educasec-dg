...
class Docente(BaseModel):
    nombres = CharField( 'Nombres', max_length=150, null=False, blank=False, )
...
class Alumno(BaseModel):
    ...
    nombres = CharField( 'Nombres', max_length=150, blank=False, )
    apellido_paterno = CharField( 'Apellido Paterno', max_length=150, blank=False, )
...
class MensajeInicio(BaseModel):
    titulo = CharField( 'Titulo', max_length=255, null=False, blank=False, )
    descripcion = TextField( 'Descripcion', null=True, blank=True )
    fecha_inicio = DateField( 'Fecha de Inicio', null=False, blank=False, )
    fecha_fin = DateField( 'Fecha de Fin', null=False, blank=False, )

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=120, verbose_name='Nombres')),
                ('last_name', models.CharField(blank=True, max_length=120, verbose_name='Apellidos')),
                ('birth_date', models.DateField(auto_now=True, null=True, verbose_name='fecha de Cumpleaño')),
